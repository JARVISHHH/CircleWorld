...
public class Game {
    ...
    public GameObject createPlainTile(Vec2d position, Vec2d spriteSize, double factor) {
        ...
        PhysicsComponent physicsComponent = new PhysicsComponent(1, 0);
    ...
    public GameObject createRock(Vec2d position, Vec2d spriteSize, double factor, Vec2i index, double restitution) {
        ...
        PhysicsComponent physicsComponent = new PhysicsComponent(30, restitution);
    ...
    public GameObject createBorder(Vec2d spriteSize, Vec2i mapGridNum) {
        ...
        FrictionComponent frictionComponent = new FrictionComponent(0.3, 0.1);
        borderObject.addComponent(frictionComponent);
